...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		map.addEntity(3, 2, "textshut");
		map.addEntity(1, 3, "textrock");
		map.addEntity(2, 3, "textis");
		map.addEntity(3, 3, "textopen");
		map.addEntity(4, 3, "textand");
		map.addEntity(5, 3, "textpush");
